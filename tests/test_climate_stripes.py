...
from vulture.stripes_lib.stripes import StripesRenderer
...
def test_StripesMakerGlobal():
    ...
    # RAL_LAT, RAL_LON = 51.570664384, -1.308832098
    df = stripes_maker.create(51.570664384, -1.308832098, output_file=outputs["png"])
    html = stripes_maker.to_html(html_file=outputs["html"], project_name="My global project")
    pdf_file = stripes_maker.to_pdf(outputs["pdf"], project_name="Another global project")
    #df = stripes_maker.create(51.23, -1.23, n_colours=10, cmap_name="winter", time_range=(1950, 2010), output_file="new-stripes.png")
